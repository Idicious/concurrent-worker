...
export declare interface ITaskOptions<T extends Array<unknown>, R, C extends IWorkerContext> {
...
export declare type Resolve<T> = (val: ThenArg<T> | PromiseLike<ThenArg<T>> | undefined) => void;
